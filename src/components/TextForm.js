  ...
  return (
    <>
        <div className='container'>
            ...
            <button className="btn btn-primary mx-2 my-2" onClick={handelClickUpper}>UpperCase</button>
            <button className="btn btn-warning mx-2 my-2" onClick={handelClickLower}>LowerCase</button>
            <button className="btn btn-info mx-2 my-2" onClick={handelClickReverse}>ReverseData</button>
            <button className="btn btn-danger mx-2 my-2" onClick={handelClickDelete}>Delete</button>
        </div>
